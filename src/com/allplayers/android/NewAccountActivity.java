...
public class NewAccountActivity extends Activity {
    ...
    private void emailError(int errorType) {
        switch(errorType) {
            case 1: mEmailEditText.setError("This field cannot be left blank.");
            break;
            case 2: mEmailEditText.setError("This is not a valid email address.");
            break;
            case 3: mEmailEditText.setError("This email address is already in use.");
            break;
            default: mEmailEditText.setError("This is not a valid email address.");
        }
    }
    ...
    private void passwordError(int errorType) {
        ...
        switch(errorType) {
            case 1: mPasswordEditText.setError("This field cannot be left blank.");
            break;
            case 2: mPasswordEditText.setError("The passwords you entered do not match.");
            break;
            case 3: mPasswordEditText.setError("Your password must contain at least:" +
                    "\n • 1 letter." +
                    "\n • 6 characters." +
                    "\n • 5 alphanumeric characters" +
                    "\n • 2 characters of different types");
            break;
            default: mPasswordEditText.setError("This is not a valid password.");
        }
    }
    ...
    private void verifyPasswordError(int errorType) {
        ...
        mVerifyPasswordEditText.setText("");
        switch(errorType) {
            case 1: mVerifyPasswordEditText.setError("This field cannot be left blank.");
            break;
            case 2: mVerifyPasswordEditText.setError("The passwords you entered do not match.");
            break;
            case 3: mVerifyPasswordEditText.setError("Your password must contain at least:" +
                    "\n • 1 letter." +
                    "\n • 6 characters." +
                    "\n • 5 alphanumeric characters" +
                    "\n • 2 characters of different types");
            break;
            default: mVerifyPasswordEditText.setError("This is not a valid email password.");
        }
    }
    ...
    private void captchaError(int errorType) {
        ...
        switch(errorType) {
            case 1: mCaptchaEditText.setError("This field cannot be left blank.");
            break;
            case 2: mCaptchaEditText.setError("This answer is incorrect.");
            break;
            default: mCaptchaEditText.setError("This is not a valid solution.");
        }
    }
